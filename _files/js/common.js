...
app.controller('AppCtrl', function($scope) {
	...
	$scope.breadcrumbRoot = '第53回宇部高専高専祭'
...
var setupShareBtns = function() {
	var url = location.href;
	var encURL = encodeURIComponent(url);
	var tw = 'https://twitter.com/share?url=' + url;
	$('#shareBtn-tw').attr('href', tw);
	var fb = 'https://www.facebook.com/share.php?u=' + encURL;
	$('#shareBtn-fb').attr('href', fb);
	var gp = 'https://plus.google.com/share?url=' + url.replace('http://', '');
	$('#shareBtn-gp').attr('href', gp);
	var ml = 'mailto:?body=' + url;
	$('#shareBtn-ml').attr('href', ml);
	if(_ua.Mobile || _ua.Tablet) {
		var ln = 'http://line.me/R/msg/text/?' + encURL;
		$('#shareBtn-ln').attr('href', ln);
	}
}
...
var addFooterHeight = function() {
	...
	$('[ng-include="footerTmp"]').height(fH);
}
